    ...
    return (
        ...
        >
            ...
            >
                ...
                <button className="bg-blue-400 text-blue-100" onClick={close}>
                    Close
                </button>
            </div>
        </Dialog>
...
const EditPostModal = ({ id, open, onClose }) => {
    ...
    return (
        ...
        >
            <div className="max-w-md mb-3 mx-auto w-screen dark:bg-black flex overflow-y-scroll flex-col p-2 gap-2 overflow-hidden">
                <div className="w-full grid-cols-[49px,_auto] h-min-content grid p-3  border-b-4 gap-1 bg-gray-100 mt-2 dark:bg-black dark:bg-opacity-90 dark:shadow-xl dark:border-gray-800">
                    ...
                    >
                        ...
                        <div>
                            <button
                                className="m-2 text--500 text-2xl"
                                onClick={chooseImageFile}
                            >
                                <iconify-icon icon="bi:image">Choose Image</iconify-icon>
                            </button>
                            <button
                                className="bg-blue-400 text-blue-50 float-right px-2 h-8 rounded-full w-20"
                                type="submit"
                            >
                                Update
                            </button>
            ...
            <button
                className="bg-blue-400 text-blue-100 w-[96%] mx-auto rounded-sm mb-4 mt-auto"
                onClick={onClose}
            >
                Close
            </button>
...
const ChangePasswordModal = ({ open, close }) => {
    ...
    return (
        <Dialog open={open} PaperProps={{ style: { background: "transparent" } }} onClose={close}>
            <div className="w-[80vw] bg-blue-50 max-w-lg p-6 h-max-content rounded-lg dark:bg-black dark:border-2 border-gray-900 rounded-lgz">
                ...
                >
                    ...
                    />
                    <div>
                        <button className="bg-blue-600 text-blue-100 rounded-full px-2 w-20 py-1 float-right mt-2">
                            Update
                        </button>
                    </div>
                </form>
