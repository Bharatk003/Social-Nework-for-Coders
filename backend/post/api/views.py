...
from .serializers import PostSerializer, CommentSerializer, ReplySerializer,TagSerializer
...
class ReplyListAPIView(ListAPIView):
    ...
    def get_queryset(self):
        ...
        return Reply.objects.filter(comment__id=comment_id).order_by("-created_at")
...
class ReplyDestroyApiView(RetrieveDestroyAPIView):
    model = Reply
    serializer_class = ReplySerializer
